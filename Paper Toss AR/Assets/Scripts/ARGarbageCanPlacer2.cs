...
public class ARGarbageCanPlacer2 : MonoBehaviour
{
    ...
    private void PlaceGarbageCan()
    {
        ...
        // Ajoutez cette ligne quand la poubelle est placée :
        _spawnedGarbageCan.GetComponent<RandomTrashMovement>().ActivateMovement();
    }
